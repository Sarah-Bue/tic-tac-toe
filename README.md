...
The sounds used on the website are by floraphonic, and downloaded from [Pixabay] (https://www.pixabay.com/).
...
The code to remove the outer borders of the board has been adapted from Patricia Nicole Opetina's code found [here] (https://www.dev.to/pat_the99/how-to-remove-outside-borders-of-a-3x3-grid-using-css-e-g-tic-tac-toe-ui-4ao8).
